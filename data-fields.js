...
const FIELDS = {
  ...
  skin: ['Albino', 'Amber skin', 'Beige skin', 'Bronze skin', 'Brown skin', 'Caramel skin', 'Dark skin', 'Deep espresso skin', 'Fair skin', 'Freckled skin', 'Golden skin', 'Light brown skin', 'Medium tan skin', 'Olive skin', 'Pale skin', 'Porcelain skin', 'Rosy skin', 'Sun-kissed skin', 'Tan skin', 'Vitiligo skin', 'Warm brown skin', 'Chocolate skin', 'Cinnamon skin', 'Cocoa skin', 'Copper skin', 'Ebony skin', 'Hazelnut skin', 'Honey skin', 'Ivory skin', 'Mahogany skin', 'Toffee skin'],

  occupation: ['Actor', 'Adventurer', 'Alchemist', 'Angel', 'Architect', 'Artist', 'Astronaut', 'Athlete', 'Baker', 'Ballerina', 'Barista', 'Biker', 'Bodyguard', 'Botanist', 'Boxer', 'Chef', 'Content creator', 'Cowgirl', 'Cyberpunk hacker', 'Dancer', 'Detective', 'DJ', 'Doctor', 'Engineer', 'Explorer', 'Fairy', 'Farmer', 'Fashion designer', 'Firefighter', 'Florist', 'Gamer', 'Goddess', 'Guide', 'Influencer', 'Journalist', 'Knight', 'Librarian', 'Mage', 'Makeup artist', 'Mechanic', 'Mermaid', 'Model', 'Motorcyclist', 'Musician', 'Ninja', 'Nurse', 'Painter', 'Paramedic', 'Photographer', 'Pilot', 'Princess', 'Professor', 'Queen', 'Researcher', 'Rockstar', 'Sailor', 'Samurai', 'Scientist', 'Singer', 'Skater', 'Soldier', 'Stylist', 'Superhero', 'Surfer', 'Teacher', 'Traveler', 'Warrior', 'Witch', 'Writer', 'Yoga instructor', 'Archaeologist', 'Bard', 'Blacksmith', 'Gladiator', 'Huntress', 'Illusionist', 'Jester', 'Mercenary', 'Oracle', 'Pirate captain', 'Priestess', 'Rogue', 'Shaman', 'Sheriff', 'Siren', 'Valkyrie', 'Vampire hunter', 'Zen monk'],

  expression: ['Adoring', 'Amazed', 'Beaming', 'Bold', 'Bright smile', 'Calm', 'Cheerful', 'Confident', 'Contemplative', 'Coy smile', 'Curious', 'Defiant', 'Determined', 'Dreamy', 'Ecstatic', 'Elegant', 'Excited', 'Fierce', 'Focused', 'Gentle smile', 'Joyful', 'Laughing', 'Loving', 'Melancholic', 'Mysterious', 'Peaceful', 'Playful', 'Proud', 'Radiant smile', 'Regal', 'Relaxed', 'Serene', 'Serious', 'Shy', 'Smiling', 'Smirking', 'Soft smile', 'Stoic', 'Sultry', 'Surprised', 'Tender', 'Thoughtful', 'Wistful', 'Bashful', 'Captivated', 'Daring', 'Enchanted', 'Grateful', 'Hopeful', 'Inspired', 'Mischievous', 'Nostalgic', 'Pensive', 'Skeptical', 'Startled', 'Vulnerable', 'Whimsical', 'Worried', 'Bored', 'Dazzled', 'Overwhelmed'],
  ...
  outerwear: ['blazer', 'bolero jacket', 'cape', 'cardigan', 'coat', 'cropped jacket', 'denim jacket', 'hoodie', 'kimono jacket', 'leather jacket', 'poncho', 'shawl', 'trench coat', 'utility jacket', 'vest', 'windbreaker', 'puffer jacket', 'raincoat', 'fleece jacket', 'anorak', 'varsity jacket', 'parka'],
  ...
  footwear: ['ankle boots', 'athletic sneakers', 'ballet flats', 'barefoot', 'combat boots', 'cowboy boots', 'dress shoes', 'espadrilles', 'flip flops', 'high heels', 'hiking boots', 'knee high boots', 'loafers', 'mary janes', 'moccasins', 'platform heels', 'running shoes', 'sandals', 'slip on shoes', 'snow boots', 'stilettos', 'wedges', 'work boots', 'rain boots', 'velcro sneakers', 'jelly sandals', 'school shoes', 'slippers'],
  ...
  holdingItem: ['Acoustic guitar', 'Balloon', 'Book', 'Bouquet', 'Bubbles', 'Camera', 'Champagne glass', 'Coffee cup', 'Crystal ball', 'Deck of cards', 'Dumbbells', 'Envelope', 'Film camera', 'Flowers', 'Gift box', 'Guitar', 'Ice cream cone', 'Journal notebook', 'Jump rope', 'Kite', 'Lantern', 'Laptop', 'Map', 'Microphone', 'Mirror', 'Paint palette', 'Parasol', 'Phone', 'Polaroid camera', 'Rose', 'Scroll', 'Shield', 'Single flower', 'Skateboard', 'Sketchbook', 'Smoothie cup', 'Sparkler', 'Staff', 'Stuffed animal', 'Tea cup', 'Teddy bear', 'Tennis racket', 'Umbrella', 'Violin', 'Wand', 'Water bottle', 'Wine glass', 'Ancient tome', 'Binoculars', 'Compass', 'Flute', 'Harp', 'Horn', 'Hourglass', 'Lute', 'Pocket watch', 'Potion bottle', 'Quill pen', 'Spell book', 'Telescope', 'Torch', 'Treasure map'],

  sceneProp: ['Basket of fruit', 'Blanket', 'Briefcase', 'Candles', 'Canvas painting', 'Dreamcatcher', 'Fishing rod', 'Fruit bowl', 'Hockey stick', 'Luggage', 'Picnic basket', 'Pillow', 'Pottery wheel', 'Shopping bags', 'Snack box', 'Snowboard', 'Soccer ball', 'Suitcase', 'Surfboard', 'Towel', 'Trophy', 'Watering can', 'Yoga mat', 'Barrel', 'Campfire', 'Hay bale', 'Market stall', 'Treasure chest'],

  backgroundProp: ['Balloon arch', 'Bokeh lights', 'Canopy of vines', 'Confetti cloud', 'Fairy lights', 'Flower wall', 'Garden arch', 'Hanging lanterns', 'Neon sign', 'Northern lights', 'Petal rain', 'String lights', 'Vintage car', 'Waterfall', 'Wildflowers', 'Castle silhouette', 'Clock tower', 'Dragon silhouette', 'Fireworks display', 'Hot air balloons', 'Phoenix in sky', 'Ship sails', 'Shooting stars', 'Volcanic plume', 'Windmill'],

  magicProp: ['Conjured fire', 'Crystal orb', 'Energy tendrils', 'Floating petals', 'Floating roses', 'Glowing aura', 'Glowing runes', 'Halo of light', 'Magical mist', 'Magic sparkles', 'Orbs of light', 'Spirit flames', 'Summoned lightning', 'Swirling leaves', 'Swirling stars', 'Dragon fire', 'Holy radiance', 'Ice shards', 'Shadow tendrils', 'Soul flames', 'Spectral wings', 'Time ripple', 'Void portal'],

  environment: ['Abandoned amusement park', 'Abandoned asylum', 'Airport', 'Ancient Egypt', 'Ancient library', 'Ancient temple ruins', 'Apple orchard', 'Aquarium tunnel', 'Art gallery', 'Art studio', 'Astronomy observatory', 'Autumn forest', 'Backyard garden', 'Balcony overlook', 'Ballroom', 'Bamboo forest', 'Barn', 'Beach', 'Beach bonfire', 'Beach resort', 'Boardwalk', 'Bookstore', 'Botanical garden', 'Boutique', 'Butterfly garden', 'Cafe', 'Calm lake', 'Candy land', 'Canyon', 'Castle courtyard', 'Cathedral', 'Cave', 'Cherry blossom garden', 'Cherry blossom park', 'City alley', 'City rooftop', 'City street', 'Cliffside overlook', 'Cloud kingdom', 'Coastal village', 'Cobblestone alley', 'Concert hall', 'Conference room', 'Coral reef', 'Countryside', 'Cozy bedroom', 'Cozy fireplace', 'Cozy kitchen', 'Covered bridge', 'Cruise ship', 'Crystal cave', 'Cyberpunk alley', 'Dance studio', 'Desert dunes', 'Desert oasis', 'Drive-in theater', 'Dreamy greenhouse', 'Enchanted forest', 'Fairy garden', 'Farm', 'Farmhouse', 'Field', 'Floating island', 'Flower field', 'Flower market', 'Fog-covered moors', 'Forest cabin', 'Forest clearing', 'Forest waterfall', 'Futuristic city', 'Garden', 'Garden maze', 'Glacier', 'Gothic castle', 'Graffiti wall', 'Grand staircase', 'Greenhouse', 'Gym', 'Harbor', 'Historic townhouse', 'Home studio', 'Hospital', 'Hot air balloon', 'Hotel lobby', 'Ice cave', 'Indoor pool', 'Infinity pool', 'Irish countryside', 'Japanese tea house', 'Jungle', 'Koi pond', 'Laboratory', 'Lake dock', 'Lake reflections', 'Lakeside cabin', 'Lavender field', 'Library', 'Lighthouse', 'Lotus pond', 'Luxury penthouse', 'Luxury yacht', 'Market bazaar', 'Mars colony', 'Meadow', 'Medieval castle', 'Misty forest', 'Modern apartment', 'Modern living room', 'Monastery', 'Moonlit beach', 'Moroccan riad', 'Mountain peak', 'Mountain trail', 'Mountain waterfall', 'Mountains', 'Movie set', 'Museum', 'Music festival', 'Nature trail', 'Neon arcade', 'Night market', 'Nightclub', 'Oasis', 'Ocean', 'Office', 'Olive grove', 'Open field', 'Orchard', 'Orchard in bloom', 'Outdoor cinema', 'Palace', 'Parisian street', 'Park', 'Pier', 'Pink salt lake', 'Pine forest', 'Poolside lounge', 'Post-apocalyptic ruins', 'Pottery studio', 'Prairie', 'Pumpkin patch', 'Rain-slicked street', 'Rainforest', 'Ranch', 'Recording studio', 'Restaurant', 'Rice terraces', 'Rock concert', 'Rocky cliffs', 'Rolling hills', 'Rooftop bar', 'Rooftop garden', 'Rose garden', 'Sailboat', 'Salon', 'Sand dunes at dawn', 'Savanna', 'Secret garden', 'Ski resort', 'Snowy cabin', 'Snowy landscape', 'Spa', 'Space station', 'Spring meadow', 'Stable', 'Summer garden', 'Sunflower field', 'Swimming pool', 'Tea plantation', 'Temple', 'Terraced garden', 'Theater stage', 'Throne room', 'Tidal pool', 'Train station', 'Treehouse', 'Tropical beach', 'Tropical island', 'Tundra', 'Underground cavern', 'Underground speakeasy', 'Underwater', 'Urban garden', 'Urban loft', 'Urban street', 'Valley', 'Victorian parlor', 'Vineyard', 'Volcano summit', 'Water park', 'Waterfall', 'Watermill', 'Wheat field', 'Wildflower meadow', 'Winery', 'Winter wonderland', 'Yoga studio', 'Zen garden', 'Ancient Greek temple', 'Ancient spirit forest', 'Anime city street', 'Brass workshop', 'Candlelit study room', 'Caribbean cove', 'Carnival midway', 'Catacombs', 'Cemetery at midnight', 'Cherry blossom shrine', 'Cozy country kitchen', 'Cyberpunk nightclub', 'Desert canyon at sunset', 'Destroyed cityscape', 'Egyptian pyramid chamber', 'Floating sky castle', 'Frontier town', 'Gold rush mine', 'Gothic cathedral ruins', 'Gothic university hallway', 'Haunted mansion', 'Holographic plaza', 'Mount Olympus', 'Mushroom grove', 'Neon corridor', 'Nordic fjord', 'Norse longhouse', 'Norse village', 'Old stone library', 'Pirate ship deck', 'Secret underground lair', 'Steam-powered city', 'Steampunk airship dock', 'Sunken shipwreck', 'Sunset cliff edge', 'Treasure island', 'Tropical rainforest canopy', 'Underground hacker den', 'Victorian clockwork factory', 'Viking longhouse', 'Wild West saloon', 'Wildflower cottage',
    'Bali rice terrace', 'Bangkok floating market', 'Beijing forbidden city', 'Great Wall of China overlook', 'Hong Kong neon skyline', 'Kyoto bamboo path', 'Mumbai street market', 'Shanghai waterfront', 'Singapore botanical gardens', 'Thai golden temple', 'Vietnamese lantern street', 'Seoul neon district', 'Angkor Wat sunrise', 'Himalayan monastery', 'Tokyo Shibuya crossing',
    'Amsterdam canal bridge', 'Barcelona Gothic Quarter', 'Edinburgh castle overlook', 'Greek island harbor', 'Istanbul grand bazaar', 'Norwegian fjord village', 'Prague old town square', 'Rome Colosseum steps', 'Scottish highlands', 'Swiss Alps chalet', 'Venice canal gondola', 'Santorini cliffside sunset', 'London phone booth', 'Tuscan vineyard hill', 'Amalfi Coast terrace', 'Vienna opera house steps',
    'Amazon river dock', 'Havana colorful street', 'Machu Picchu sunrise', 'New Orleans French Quarter', 'Rio carnival street', 'Rio de Janeiro overlook', 'Route 66 desert road', 'Yosemite valley floor', 'Times Square NYC', 'Hollywood red carpet', 'Nashville honky tonk street', 'Sedona red rocks', 'Niagara Falls overlook', 'Alaskan glacier bay', 'Caribbean harbor village',
    'African savanna sunset', 'Cairo marketplace', 'Moroccan desert camp', 'Serengeti grassland', 'Victoria Falls overlook', 'Zanzibar beach', 'Dubai desert safari', 'Jerusalem old city', 'Petra canyon entrance', 'Marrakech riad courtyard', 'Cape Town waterfront', 'Sahara star camp',
    'Australian outback road', 'Bora Bora overwater bungalow', 'Great Barrier Reef shallows', 'New Zealand mountain valley', 'Sydney harbor bridge', 'Fiji tropical lagoon',
    'Amazon canopy bridge', 'Borneo jungle hut', 'Cloud forest canopy', 'Dense bamboo thicket', 'Jungle river crossing', 'Jungle rope bridge', 'Mangrove swamp', 'Tropical bioluminescent bay', 'Tropical fruit grove', 'Tropical lagoon', 'Cenote underground pool', 'Jungle temple steps',
    'Bedouin tent camp', 'Desert moonrise', 'Monument Valley road', 'Sahara sand sea', 'Salt flats mirror', 'Sandstone arch formation', 'White sands desert', 'Desert campfire circle', 'Oasis palm grove',
    'Art deco theater lobby', 'Baroque chapel', 'Industrial loft space', 'Japanese ryokan room', 'Penthouse rooftop terrace', 'Retro American diner', 'Vintage bookshop', 'Wine cellar', 'Speakeasy cocktail bar', 'Rooftop infinity pool', 'Grand library reading room', 'Ornate mirror hallway',
    'Cherry blossom tunnel', 'Corn maze path', 'Harvest festival grounds', 'Ice skating rink', 'Maple forest in autumn', 'Night garden with lanterns', 'Rain on window view', 'Snow-covered village square', 'Spring flower arch', 'Summer bonfire pit', 'Foggy morning dock', 'Moonlit hilltop',
    'Canal city at dusk', 'Cliffside village', 'Hot springs pool', 'Mosque courtyard', 'Pagoda hillside', 'Souk marketplace', 'Synagogue interior', 'Japanese tea garden'],

  lighting: ['Aurora glow', 'Backlit sunset', 'Bioluminescent glow', 'Blue hour light', 'Blue water reflections', 'Bonfire light', 'Bright blue sky', 'Bright fluorescent', 'Bright gym lighting', 'Bright midday sunlight', 'Bright natural sunlight', 'Candlelight', 'Chandelier glow', 'Christmas lights', 'Cinematic lighting', 'Clinical lighting', 'Colorful neon lights', 'Cosmic glow', 'Cyberpunk neon', 'Dappled sunlight', 'Dawn light', 'Desert midday sun', 'Divine golden light', 'Dramatic side lighting', 'Dramatic stage light', 'Dramatic storm lighting', 'Dramatic sunset', 'Edison bulbs', 'Fairy lights', 'Fire glow', 'Flickering torchlight', 'Floating candles', 'Fog machine haze', 'Foggy atmosphere', 'Galaxy glow', 'Glittering sparkle', 'Golden hour sunset', 'Hazy light', 'Holographic signs', 'Lantern light', 'Laser beams', 'Lightning storm', 'Magical energy', 'Misty light', 'Moonlight', 'Natural daylight', 'Neon signs', 'Northern lights', 'Overcast light', 'Pink sunset glow', 'Purple magical energy', 'Ray tracing', 'Reflection light', 'Ring light', 'Rim lighting', 'Snow-reflected light', 'Soft diffused light', 'Soft morning light', 'Soft natural light', 'Soft studio lighting', 'Spotlights', 'Stage lighting', 'Starlight', 'String lights', 'Studio lighting', 'Sunbeam through window', 'Sunset city lights', 'Torch light', 'Twilight glow', 'Underwater sunbeams', 'Volumetric lighting', 'Warm amber lighting', 'Warm cafe lighting', 'Warm indoor lighting', 'Warm lamp light', 'Warm sunlight', 'Warm window light', 'Anime-style light beams', 'Arctic white light', 'Bioluminescent cave glow', 'Campfire glow', 'Candlelit dungeon', 'Carnival neon lights', 'Cyberpunk hologram light', 'Electric storm glow', 'Foggy lantern glow', 'Rainbow prism light', 'Starry night sky', 'Sunburst through clouds', 'Disco ball reflections', 'Fireworks glow', 'Lava glow', 'Stained glass light', 'Streetlamp glow'],
  ...
  pose: [
    ...
    'Drawing sword from hip, one hand on scabbard',
    'Casting spell with both hands raised, energy forming between palms',
    'Steering ship wheel with both hands, looking ahead confidently',
    'Aiming bow and arrow, standing sideways in archer stance',
    'Climbing rocky surface, one hand gripping rock above',
    'Sitting on throne with regal posture, hands on armrests',
    'Kneeling with sword planted in ground, head bowed',
    'Standing in doorway, one hand on frame, silhouetted',
    'Leaning on railing overlooking scenery, arms resting',
    'Holding baby tenderly in arms, looking down lovingly',
    'Sitting on edge of dock, feet dangling over water',
    'Standing in rain, face tilted up, arms slightly out',
    'Tying hair back with both hands raised behind head',
    'Walking through tall grass, one hand trailing through stalks',
    'Sitting at vanity mirror, applying makeup with one hand',
    'Standing at easel painting, brush in right hand, palette in left',
    'Crouching to pet animal, one hand extended down',
    'Carrying child on hip, one arm supporting, other free',
    'Riding horseback, reins held in both hands',
    'Dancing with partner, one hand held, other on shoulder'
  ],

  mood: ['adventurous exploratory mood', 'artistic creative mood', 'bold daring mood', 'calm tranquil mood', 'carefree lighthearted mood', 'cheerful bubbly mood', 'confident heroic mood', 'cozy intimate mood', 'dark brooding mood', 'dreamy ethereal mood', 'earthy grounded mood', 'elegant sophisticated mood', 'empowered confident mood', 'energetic vibrant mood', 'ethereal otherworldly mood', 'festive celebratory mood', 'fierce powerful mood', 'flirty playful mood', 'glamorous dazzling mood', 'happy relaxed mood', 'healthy active mood', 'introspective quiet mood', 'joyful happy mood', 'lively energetic mood', 'luxurious refined mood', 'magical whimsical mood', 'melancholic wistful mood', 'mysterious enchanting mood', 'nostalgic reflective mood', 'passionate intense mood', 'peaceful content mood', 'peaceful serene mood', 'playful adventurous mood', 'powerful bold mood', 'raw authentic mood', 'relaxed comfortable mood', 'romantic cozy mood', 'sensual alluring mood', 'soft feminine mood', 'soft whimsical mood', 'sporty dynamic mood', 'tender emotional mood', 'timeless classic mood', 'victorious triumphant mood', 'wild untamed mood', 'cinematic dramatic mood', 'coastal breezy mood', 'cyberpunk gritty mood', 'desert wanderer mood', 'gothic romantic mood', 'island paradise mood', 'midnight enchanted mood', 'rustic farmhouse mood', 'steampunk industrial mood', 'tropical vibrant mood', 'vintage nostalgic mood', 'winter fairy tale mood', 'warrior battle mood', 'celestial divine mood', 'pirate seafaring mood', 'scholarly contemplative mood', 'cozy hygge mood', 'cyberpunk neon mood', 'dark gothic mood', 'whimsical fairytale mood', 'zen meditative mood'],

  bellyShape: ['round belly', 'low-hanging belly', 'compact belly', 'wide belly', 'torpedo-shaped belly', 'high and tight belly', 'pear-shaped belly', 'basketball-shaped belly', 'teardrop-shaped belly', 'capsule-shaped belly forward-projecting', 'prominent belly', 'enormous belly', 'massive belly', 'subtle baby bump', 'visible baby bump', 'very large belly']
...
const RANDOMIZER_CORE = {
  expression: ['Adoring', 'Amazed', 'Beaming', 'Bold', 'Calm', 'Cheerful', 'Confident', 'Contemplative', 'Curious', 'Defiant', 'Determined', 'Dreamy', 'Elegant', 'Excited', 'Fierce', 'Focused', 'Joyful', 'Laughing', 'Loving', 'Melancholic', 'Mysterious', 'Peaceful', 'Playful', 'Proud', 'Regal', 'Relaxed', 'Serene', 'Serious', 'Shy', 'Smiling', 'Smirking', 'Soft smile', 'Stoic', 'Sultry', 'Surprised', 'Tender', 'Thoughtful', 'Wistful', 'Bashful', 'Captivated', 'Daring', 'Enchanted', 'Grateful', 'Hopeful', 'Inspired', 'Mischievous', 'Nostalgic', 'Pensive', 'Whimsical'],
...
// ==========================================
// Which FIELDS.age values describe a subject who is not an adult.
// 'late teen' is included deliberately: the label spans 17-19, so it is
// treated as a minor wherever the distinction matters.
const MINOR_AGES = ['baby', 'toddler', 'young child', 'child', 'preteen', 'early teen', 'mid teen', 'late teen'];
const YOUNG_AGES = ['baby', 'toddler', 'young child', 'child', 'preteen'];

// Items removed from every pool when the subject is a minor. These are
// swimwear, underwear, sleepwear, body-conscious and sheer/fetish items,
// plus the two camera styles whose whole subject is sensuality.
// This list is enforced, not merely preferred — see ageFilter() in index.html.
const ADULT_ONLY = {
  camera: ['boudoir portrait photography', 'glamour portrait photography'],
  top: ['Bikini top', 'Triangle bikini top', 'Tankini top', 'Bralette', 'Camisole', 'Corset', 'Crop top', 'Off-shoulder top', 'Halter top'],
  bottom: ['Bikini bottoms', 'High-waisted shorts', 'Mini skirt', 'Sarong', 'Swim skirt'],
  onePiece: ['Babydoll dress', 'Ball gown', 'Bathrobe', 'Bodycon dress', 'Bodysuit', 'Bustier dress', 'Catsuit', 'Corset dress', 'Corset gown', 'Evening gown', 'Feathered gown', 'Lace dress', 'Latex bodysuit', 'Leather jumpsuit', 'Mermaid gown', 'Mini dress', 'Nightgown', 'Off-shoulder dress', 'One-piece swimsuit', 'Open-back dress', 'Robe', 'Sequin dress', 'Slip dress', 'Strapless dress', 'Swimdress', 'Velvet gown', 'Wedding dress', 'Maternity dress'],
  topFabric: ['Lace', 'Mesh', 'Organza', 'Leather'],
  bottomFabric: ['Lace', 'Mesh', 'Leather', 'Faux leather'],
  onePieceFabric: ['Lace', 'Mesh', 'Organza', 'PVC', 'Leather'],
  hosiery: ['fishnet stockings', 'sheer stockings', 'sheer tights', 'thigh high stockings', 'pantyhose'],
  hosieryFabric: ['fishnet', 'lace', 'mesh', 'sheer nylon'],
  hosieryColor: ['nude'],
  footwear: ['stilettos', 'platform heels', 'high heels'],
  clothingStyle: ['Swimwear'],
  clothingPresetType: ['Swimwear', 'Maternity'],
  clothingPreset: ['Bikini Set', 'Pool Party Set', 'Resort Swim Set', 'Beach Lounge Set', 'Beach Cover-Up Set', 'Sunset Boardwalk Set', 'Tropical Waterfall Set', 'Maternity Studio Set', 'Studio Glam Set', 'Date Night Dress Set', 'Gothic Romance Set', 'Holiday Glam Set'],
  clothingTheme: ['Swimwear', 'Maternity'],
  pregnancy: ['pregnant', 'heavily pregnant']
};

// Preferred pools for children and preteens, so the randomizer reaches for
// play clothes rather than merely avoiding the blocked list.
const YOUNG_PREFERRED = {
  top: ['Graphic tee', 'Striped tee', 'T-shirt', 'Long-sleeve tee', 'Hoodie', 'Sweatshirt', 'Sweater', 'Cardigan', 'Flannel shirt', 'Polo shirt', 'Button-up shirt', 'Turtleneck', 'Fleece pullover', 'Puffer vest', 'Rugby shirt', 'School blazer', 'Denim jacket', 'Raincoat', 'Thermal top', 'Tank top'],
  bottom: ['Jeans', 'Denim shorts', 'Shorts', 'Cargo shorts', 'Bermuda shorts', 'Leggings', 'Joggers', 'Sweatpants', 'Track pants', 'Corduroy pants', 'Dungarees', 'Chinos', 'Snow pants', 'Pleated school skirt', 'Corduroy skirt', 'Skater skirt', 'A-line skirt', 'Pleated skirt', 'Athletic shorts'],
  onePiece: ['Onesie', 'Play dress', 'Party dress', 'Sailor dress', 'School uniform', 'Dungaree dress', 'Peter Pan collar dress', 'Pinafore dress', 'Snowsuit', 'Overalls', 'Overall shorts', 'Romper', 'Sundress', 'Floral sundress', 'A-line dress', 'Shift dress', 'Smock dress', 'Apron dress', 'Tulle dress', 'Tutu', 'Leotard', 'Costume', 'Cosplay outfit', 'Superhero suit', 'Coveralls'],
  footwear: ['athletic sneakers', 'running shoes', 'velcro sneakers', 'school shoes', 'rain boots', 'snow boots', 'sandals', 'jelly sandals', 'ballet flats', 'mary janes', 'slip on shoes', 'flip flops', 'slippers', 'hiking boots', 'barefoot'],
  hosiery: ['ankle socks', 'knee high socks', 'wool socks', 'footless tights', 'patterned tights', 'leg warmers']
};
